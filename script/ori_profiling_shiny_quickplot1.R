...
# plot_landscape(mut=mut,cli=cli,bar = 'TMB',bartype="continuous",feature=c("GENDER","Smoker"),prefix="test",n = 30)
# plot_landscape(mut=mut,cli=cli,bar = "GENDER",bartype="discrete",feature=c("GENDER"),prefix="test",n = 30,quickplot=T)
# plot_landscape(mut=mut,cli=cli,bar = NULL,bartype="discrete",feature=c("GENDER"),prefix="test",n = 30)
# plot_landscape(mut=mut,cli=cli,bar = NULL,bartype="discrete",feature=c("GENDER","Smoker"),prefix="test",n = 30)
# plot_landscape(mut=mut,cli=cli,bar = "Smoker",bartype="discrete",feature=c("Smoker"),prefix="test",n = 30)
# plot_landscape(mut=mut,cli=cli,bar = "Smoker",bartype="discrete",feature=c("Smoker"),prefix="test",n = 30,)
## example2
# mut <- read.xlsx("E:/song/project/20191106biomarker/shiny/demo/pipeline/Himalaya/example/example_mutation.xlsx")
# cli <- read.xlsx("E:/song/project/20191106biomarker/shiny/demo/pipeline/Himalaya/example/example_info.xlsx")
# pathway <- read.xlsx("E:/song/project/20191106biomarker/shiny/demo/pipeline/Himalaya/example/example_pathway.xlsx")
# plot_pathway_cli(mut = mut,cli = cli,bar="TMB",bartype="continuous",feature = c("GENDER","Smoker"),
#                  prefix="test",pathway_genes=pathway, quickplot=F , waterfall=F, resam=F, nfreq=0.02, cutoff=NULL,rownamessize=8)
# plot_pathway_cli(mut = mut,cli = cli,bar="GENDER",bartype="decrete",feature = c("GENDER"),
#                  prefix="test",pathway_genes=pathway, quickplot=F , waterfall=F, resam=F, nfreq=0.02, cutoff=NULL,rownamessize=8)
# plot_pathway_cli(mut = mut,cli = NULL,bar="GENDER",bartype="decrete",feature = c("GENDER"),
#                  prefix="test",pathway_genes=pathway, quickplot=F , waterfall=F, resam=F, nfreq=0.02, cutoff=NULL,rownamessize=8)
# plot_pathway_cli(mut = mut,cli = cli,bar="GENDER",bartype="decrete",feature = c("GENDER"),
#                  prefix="test",pathway_genes=pathway, quickplot=T , waterfall=F, resam=F, nfreq=0.02, cutoff=NULL,rownamessize=8)

plot_landscape = function(mut,cli=NULL,bar,bartype="continuous",feature,prefix,quickplot=F,waterfall=F,resam=F,cutoff=NULL,n = 30,rownamessize=8){
  ...
  if(is.null(cli)){
    ...
    allsamples = unique(cli[["ORDER_ID"]])
  }
  ...
  if(!is.null(cli)){
    ...
    if(bartype=="continuous"){
      annoInfo<- ori_HeatmapAnnotation_preorder(cli,bar,feature,cutoff=cutoff)
    }else{
      annoInfo<- ori_HeatmapAnnotation_preorder(cli,bar=NULL,feature,cutoff=NULL)
    }
    ...
    annoInfo = annoInfo[match(mutN$ORDER_ID, rownames(annoInfo)),,drop=F]
    if(bartype=="continuous"){
      HA = ori_HeatmapAnnotation(annoInfo,feature,bar=bar,resam=resam,annotationsize=rownamessize)
    }else{
      HA = ori_HeatmapAnnotation(annoInfo,feature,bar=NULL,resam=resam,annotationsize=rownamessize)
    }
...
plot_pathway_cli = function(mut, cli=NULL, bar, bartype="continuous",feature, prefix, 
